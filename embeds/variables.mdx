---
title: 'Variables'
description: 'In this section, you will be able to view the variables that you can use for Evict's embeds.'
---
...
| `{guild.icon}`             | Shows guild's icon                      | `https://r2.evict.cc/evict.png`       |
...
| Variable                   | Output                                  | Example                              |
|----------------------------|-----------------------------------------|--------------------------------------|
| `{user}`                   | Shows user full name with discriminator | `x32u#0`                             |
| `{user.name}`              | Shows user's username                   | `x32u`                               |
| `{user.discriminator}`     | Shows user's discriminator              | `#0`                                 |
| `{user.id}`                | Shows user's id                         | `123456789012345678`                 |
| `{user.mention}`           | Mentions the user                       | `@x32u`                              |
...
<Tabs>
  ...
  <Tab title="Tiktok">
    | Variable                   | Output                                  | Example                               |
    |----------------------------|-----------------------------------------|-------------------------------------- |
    | `{username}`               | The tiktok username                     | `@evict`                              |
    | `{full_name}`              |  The tiktok name                        | `divinity`                            |
    | `{avatar_url}`             |  The tiktok avatar                      | `https://evict.cc/evict.png`          |
